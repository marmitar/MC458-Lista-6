...
Portanto, $T(n) \in \Theta\left(S k\right)$. A complexidade de espaço é $\Theta(k)$, já que todo espaço alocado faz parte da solução, com exceção da última chamada de $\proc{Segmentos-Ótimos}$.
